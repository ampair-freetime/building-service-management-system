    ...
    claims: [
      {
        ...
        status: "รอตรวจสอบ",
        assignee: "ชนาภา มณีวงศ์",
        requester: "กิตติพงษ์ ศรีสุข",
        requestDate: "วันนี้ 09:20",
        contact: "kittipong@example.com",
        appointment: "ยังไม่มีนัดหมาย",
        evidence: "ระบุจำนวนกุญแจ สีของพวงกุญแจ และตำหนิได้ตรงกับรายการ",
        secret: "แจ้งข้อความบนป้ายพวงกุญแจเพื่อใช้ตรวจสอบต่อหน้าเจ้าหน้าที่",
      },
      {
        id: "CM-032",
        ...
        custody: "พร้อมนัดรับ",
        status: "นัดหมายแล้ว",
        requester: "วรัญญา ใจดี",
        requestDate: "เมื่อวาน 15:40",
        contact: "waranya@example.com",
        appointment: "วันนี้ 16:30 · ประชาสัมพันธ์ชั้น 1",
        evidence: "ชื่อบนบัตรและเลขท้ายรหัสนักศึกษาตรงกับข้อมูลที่แจ้ง",
        secret: "ต้องแสดงบัตรประจำตัวก่อนรับคืน",
      },
      {
        id: "CM-029",
        ...
        requester: "ธนภัทร แสงคำ",
        requestDate: "28 ก.ค. 13:10",
        contact: "thanapat@example.com",
        appointment: "ยังไม่มีนัดหมาย",
        evidence: "รายละเอียดสีตรงกับประกาศ แต่ข้อมูลสิ่งของภายในยังไม่ครบ",
        secret: "รอผู้ขอแจ้งรายละเอียดช่องเก็บของและสิ่งของภายในเพิ่มเติม",
      },
    ],
  };
  let deletedRecords = [];
